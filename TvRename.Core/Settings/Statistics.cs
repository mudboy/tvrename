...
namespace TvRename.Core.Settings
{
    ...
    public class TVRenameStats
    {
        ...
        [XmlIgnore] public int NS_NumberOfEpisodes = -1; // -1 = unknown
        [XmlIgnore] public int NS_NumberOfEpisodesExpected = 0;
        [XmlIgnore] public int NS_NumberOfSeasons = 0;
        [XmlIgnore] public int NS_NumberOfShows = 0;
