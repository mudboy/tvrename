...
namespace TvRename.Core.BT
{
    ...
    public class BTFileRenamer : BTCore
    {
        ...
        public IList<Item> RenameListOut;
        ...
        {
            this.RenameListOut.Add(new ActionCopyMoveRename(this.CopyNotMove ? ActionCopyMoveRename.Op.Copy : ActionCopyMoveRename.Op.Rename, onDisk, Helpers.FileInFolder(this.CopyNotMove ? this.CopyToFolder : onDisk.Directory.Name, nameInTorrent), null,new TVRenameStats()));
