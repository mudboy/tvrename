...
public static class GlobalMembersTVRename {
    ...
    private static int Main(string[] args) {
        ...
        bool createdNew;
        Mutex mutex = new Mutex(true, "TVRenameMutex", out createdNew);
        if (!createdNew) {
            // we're already running
            return SignalOtherInstance(args, clargs);
        }
    ...
    private static int SignalOtherInstance(string[] args, CommandLineArgs clargs) {
